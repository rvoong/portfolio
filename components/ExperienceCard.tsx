  ...
  return (
    ...
    hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration overflow-hidden">
        ...
        <div className="px-0 md:px-10">
            <h4 className="text-4xl font-light"> Engineer at Northrop Grumman </h4>
            <p className="font-bold text 2xl mt-1"> Engineer </p>
        ...
        <ul className="list-disc space-y-4 ml-5 text-lg h-80 overflow-y-scroll pr-5">
